...
const score0El = document.getElementById('score--0'); // without the hash (#)
...
const init = function() {                   // init --> initialization function
...
//btnNew.addEventListener('click', function(){
  ...
  // // Roll dice and hold Buttons should work as normal
  // playing = true;

  // // Final Scores should be Zero
  // scores[0] = 0;
  // scores[1] = 0;
